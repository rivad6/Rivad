...
export function RandomFacts() {
  ...
  return (
    <>
      <button
        onClick={handleOpen}
        className="group relative inline-flex items-center gap-2 px-6 py-4 bg-brand-accent/10 border border-brand-accent/30 hover:bg-brand-accent hover:border-brand-accent transition-all duration-300 backdrop-blur-sm sm:min-w-[220px] justify-center shadow-[4px_4px_0_rgba(242,74,41,0.3)] hover:shadow-[0_0_0_rgba(242,74,41,0)] hover:translate-x-[4px] hover:translate-y-[4px]"
      >
