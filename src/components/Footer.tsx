...
export function Footer() {
  ...
  return (
    <footer className="bg-[#050000] text-gray-300 border-t border-red-900/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-32 relative z-10">
        ...
        <div className="mb-24" id="contacto">
          <h2 className="text-sm font-mono tracking-[0.4em] text-red-500/60 uppercase mb-8 border-b border-red-500/20 pb-4 inline-block w-full md:w-auto transition-all duration-500">
            04 // {t('footer.links.comms')}
          </h2>
          <h3 className="text-[12vw] md:text-[9vw] font-display uppercase tracking-[-0.04em] leading-[0.8] w-full text-balance text-red-50 text-center transition-all duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-32">
          ...
          <div className="flex flex-col justify-start">
            ...
            <a 
              ...
              className="group inline-flex items-center justify-between w-full md:w-max px-8 py-6 border border-white/5 hover:border-red-600 hover:bg-red-600 hover:text-white transition-all duration-700 font-mono text-xl md:text-2xl mb-24 text-gray-100 frosted-layer"
            >
              ...
              <div>
                ...
                <ul className="flex flex-col space-y-6">
                  <li className="flex flex-col text-gray-400 font-light group">
                    <span className="text-[9px] font-mono uppercase text-gray-700 mb-2 transition-colors duration-300 group-hover:text-red-400">{t('footer.comms')}</span>
                  ...
                  <li className="flex flex-col text-gray-400 font-light group">
                    <span className="text-[9px] font-mono uppercase text-gray-700 mb-2 transition-colors duration-300 group-hover:text-red-400">{t('footer.base')}</span>
                  ...
                  {[
                    ...
                    <li key={social.name}>
                      <a 
                        ...
                        className="text-sm font-mono text-gray-500 hover:text-red-400 flex items-center gap-2 group transition-all duration-300"
                      >
                        {social.name}
          ...
          <div className="relative p-8 md:p-12 border border-white/5 bg-[#050000] frosted-layer group overflow-hidden rounded-3xl transition-all duration-700 hover:border-red-900/40">
            ...
            <h3 className="text-2xl font-display font-light mb-12 pb-6 border-b border-white/5 flex justify-between items-center text-red-50">
              <span className="font-serif italic">{t('footer.direct')}</span>
              <span className="font-mono text-[9px] text-red-500 border border-red-500/30 bg-red-500/5 px-3 py-1.5 uppercase tracking-[0.3em] rounded-full">{t('footer.online')}</span>
            </h3>
            ...
            <form className="space-y-10" onSubmit={(e) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    name="name"
                    required
                    className="w-full bg-transparent border-b border-white/10 py-4 text-white focus:outline-none focus:border-red-600 transition-colors duration-300 px-1 font-sans text-lg placeholder:text-gray-800"
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <select id="topic" name="topic" required className="w-full bg-transparent border-b border-white/10 py-4 text-gray-500 focus:outline-none focus:border-red-600 transition-colors duration-300 px-1 appearance-none font-sans text-lg cursor-pointer hover:text-white">
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  ...
                  required
                  rows={4}
                  className="w-full bg-transparent border-b border-white/10 py-4 text-white focus:outline-none focus:border-red-600 transition-colors duration-300 px-1 resize-none font-sans text-lg placeholder:text-gray-800 leading-relaxed"
        ...
        <div className="mt-40 pt-10 border-t border-red-900/20 flex flex-col items-center gap-8 text-[9px] font-mono text-gray-600 uppercase tracking-[0.4em] text-center w-full">
          <div className="flex flex-col md:flex-row justify-between items-center w-full gap-8">
            <p>© {new Date().getFullYear()} By Rivad. {t('footer.rights')}</p>
            <div className="flex items-center gap-6">
              <span className="w-1.5 h-1.5 bg-red-600/60 rounded-full animate-pulse shadow-[0_0_5px_rgba(220,38,38,0.5)]"></span>
              <p className="hover:text-red-400 transition-colors cursor-default">{t('footer.made')}</p>
            </div>
          </div>
          <div className="pt-4 border-t border-red-900/10 w-full flex flex-col justify-center gap-2 text-gray-700">
